$(function(){
	...
	$("a[name='delBtn']").live("click",function(){
		...
		$.ajax({
			url: SystemProp.appServerUrl+"/golf/ios-manage!updateStatusIosPush.action",
			type: "POST",
			dataType: "json",
			data: data,
			success: callback
	...
	$("a[name='editBtn']").live("click",function(){
		...
		$.ajax({
			url: SystemProp.appServerUrl+"/golf/ios-manage!getPojoJson.action",
			type: "POST",
			dataType: "json",
			data: data,
			success: callback
	...
	function pageComm(currentPage){
		...
		$.ajax({
			url: SystemProp.appServerUrl+"/golf/ios-manage!listJson.action",
			type: "POST",
			dataType: "json",
			data: data,
			success: callback
