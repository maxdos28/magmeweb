$(function(){
	...
	$("a[name='delBtn']").live("click",function(){
		...
		$.ajax({
			url: SystemProp.appServerUrl+"/new-publisher/ios-manage!updateStatusIosPush.action",
			type: "POST",
			dataType: "json",
			data: data,
			success: callback
	...
	$("a[name='editBtn']").live("click",function(){
		...
		$.ajax({
			url: SystemProp.appServerUrl+"/new-publisher/ios-manage!getPojoJson.action",
			type: "POST",
			dataType: "json",
			data: data,
			success: callback
	...
	$("#iosMessageOk").live("click",function(){
		...
		$.ajax({
			url: SystemProp.appServerUrl+"/new-publisher/ios-manage!addIosPush.action",
			type: "POST",
			dataType: "json",
			data: data,
			success: callback
	...
	function pageComm(currentPage){
		...
		$.ajax({
			url: SystemProp.appServerUrl+"/new-publisher/ios-manage!listJson.action",
			type: "POST",
			dataType: "json",
			data: data,
			success: callback
