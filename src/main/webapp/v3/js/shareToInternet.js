var shareToObj = {
	defaultInfo:{
		...
		title: "看杂志 ·上麦米网",
		imgsrc:"http://static.magme.com/v3/images/logo20120428.gif",
		desc:''
	},
	shareType: function (type,tagInfo){
		switch(type)
		{
			...
			case 'qzone':
				...
				break;
			case 'kaixin':
				shareToObj.shareToKaixin(tagInfo);
				break;
		}
		//统计第三方分享
		if($ma){
			var dataUrl = "/third/share?type="+type+"&target="+encodeURIComponent(tagInfo.url);
			$ma(dataUrl,"0");
		}
	},
    ...
    shareToKaixin: function(setting) {
    	var tagInfo = $.extend({},shareToObj.defaultInfo,setting);
    	javascript: void((function(s, d, e) {
            try {} catch(e) {}
            var f = 'http://www.kaixin001.com/repaste/share.php?';
            var s = {
        		rurl: tagInfo.url,
    	...
    	javascript: void((function(s, d, e) {
		    try {
		    	var shareInfo = {
				  ...
				  "title": tagInfo.title,
				  "link": tagInfo.url,
				  "image_src": tagInfo.imgsrc,
				  "message": "这个标签不错啊，可以去看看！",
