...
;(function($){
	...
	$.fancybox.init = function() {
		...
		$('body').append(
			...
			wrap = $('<div id="fancybox-wrap" class="popAdmin"><a class="del" id="fancybox-close" title="关闭"></a></div>')
		);
...
//			.appendTo( wrap );
		...
		close = $('<a id="fancybox-close"></a>').appendTo(wrap);
	...
	$.fn.fancybox = function(options){
		...
		_get_obj_pos = function(obj) {
			...
			pos.width = obj.outerWidth(true)-30;//offsetHeight fix -30 20120817 by lewis
			pos.height = obj.outerHeight(true)+28;//offsetHeight fix +28 20120817 by lewis
			return pos;
		},
	...
	$.fancybox.center = function(isFirst,windowCenter) {
		...
		var warpStyle = {'top' : top/2,'left' : left};
//		if(windowCenter){
