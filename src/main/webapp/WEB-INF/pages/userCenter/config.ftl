	<div class="conMiddleRight">
        <!--conMyTag-->
        <div class="conMyConfig">
        	<h2>账户设置</h2>
            <fieldset class="new">
                <form id="editUserInfoForm" method="post" action="" onsubmit="return false;">
                <div class="important">
                    <em class="title">原密码</em>
                    <em><input id="oldPassword" name="oldPassword" class="input g180" type="password"></em>
                    <em class="tips">不需要修改密码，请留空</em>
                </div>
                <div class="important">
                    <em class="title">新密码</em>
                    <em class="g250"><input id="password" name="password" class="input g180" type="password"></em>
                    <em class="title">确认密码</em>
                    <em><input id="password2" name="password2" class="input g180" type="password"></em>
                </div>
                <hr />
                <div>
                    <em class="title">用户名</em>
                    <em class="g250"><input id="userName" name="userName" value="${session_user.userName}" class="input g180" type="text" disabled=""></em>
                    <em class="title">昵称</em>
                    <em><input id="nickName" name="nickName" value="${session_user.nickName}" class="input g180" type="text"></em>
                </div>
                <div>
                    <em class="title">邮箱</em>
                    <em class="g250"><input id="email" name="email" value="${session_user.email}" class="input g180" type="text"></em>
                    <em class="title">联系电话</em>
                    <em><input id="phone" name="phone" value="${(session_user.phone)!""}" class="input g180" type="text"></em>
                </div>
                <div>
                    ...
                    <em class="g160"><label><input type="radio" name="gender" value="0">保密</label></em>
                    <em class="title">生日</em>
                    <em><input id="birthdate" name="birthdate" value="${(session_user.birthdate?string("yyyy-MM-dd"))!""}" class="input g180" type="text"></em>
                    <em>(1985-01-11)</em>
                </div>
                <hr />
                <div>
                    <em class="title">职业</em>
                    <em class="g250"><input id="occupation" name="occupation" value="${(session_user.occupation)!""}" class="input g180" type="text"></em>
                ...
                <div>
                    ...
                    <em class="g250"><select id="astro" name="astro" class="g90" >
                    ...
                    <em class="g250"><select id="bloodType" name="bloodType" class="g90" >
                ...
                <div>
                    ...
                    <em><input id="hobbies" name="hobbies" rows="4" class="input g520" value="${(session_user.hobbies)!""}" type="text"></em>
                </div>
                <hr />
                <div>
