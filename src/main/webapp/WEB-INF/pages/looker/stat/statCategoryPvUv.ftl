...
<script type="text/javascript" src="${systemProp.staticServerUrl}/look/js/statCategoryPvUv.js"></script>
<div class="body" menu="stat" submenu="statcate1">
   ...
   <div class="conB">
		<h2 class="tCenter">分类（栏目）浏览量报表</h2>
