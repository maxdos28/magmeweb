...
<script src="${systemProp.staticServerUrl}/look/js/articleEdit.js"></script>
    	...
    	<div class="con116 conTools">
        	<fieldset>
              <div>
                    ...
                    <em class="g145"><select id="s-category" class="g140"><option value="-1">全部分类</option></select></em>
                    <em class="g145"><select id="s-item" class="g140"><option value="-1">全部栏目</option></select></em>        
