...
<script type="text/javascript" src="${systemProp.staticServerUrl}/phoenix/js/statCategoryTrend.js"></script>
<!--header-->
<@header.main menuId="appdata"/>
<div class="body">
      <div class="conLeftMiddleRight" style="min-height:600px;">
      	<div class="conTools clearFix tCenter">
        <a href="${systemProp.appServerUrl}/phoenix/phoenix-stat-category-pv-uv.action" class="btnSM">阅读数量</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${systemProp.appServerUrl}/phoenix/phoenix-stat-category-trend.action" class="btnAM">阅读趋势</a>
        </div>
    	<div class="conB">
		<h2>过滤条件</h2>
		<fieldset>
