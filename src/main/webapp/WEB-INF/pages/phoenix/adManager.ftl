...
<script src="${systemProp.staticServerUrl}/phoenix/js/ad.js"></script>
<!--[if lt IE 7]>
...
<div class="body">
    <div class="conLeftMiddleRight">
		...
		<a href="${systemProp.domain}/phoenix/phoenix-ad.action" class="btnAM">封面广告</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${systemProp.domain}/phoenix/phoenix-category-ad.action" class="btnSM">栏目广告</a>
        </div>
    	<div class="conTools clearFix tCenter">
        	<fieldset>
            	<div>
                	<em>名称</em>
                	<em><input type="text" class="input g140 " id="s-title"/></em>
    	...
    	<fieldset>
            ...
            <input type="hidden" name="id" id="adId" class="input g300" />
               <div>
                ...
                <div>
                    <em class="g50">图片</em>
                    <em><input type="file" name="adPicPad" id="adPicPad" class="inputFile g200" />PAD(768*645)</em>
                </div>
                <div>
                    <em class="g50">图片</em>
                    <em><input type="file" name="adPicPhone" id="adPicPhone" class="inputFile g200" />PHONE(720*432)</em>
                </div>
