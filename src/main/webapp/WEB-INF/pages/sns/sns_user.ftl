...
<head>
<title>${userInfo.nickname!}的作品 - 麦米网Magme </title>
	...
	<div class="sideRight">
    	<div class="con conHead">
        	<a class="head" href="javascript:void(0);" title='${userInfo.nickname!}'>
        	 	<img url="<#if !session_user?? || userInfo.id!=session_user.id>${systemProp.appServerUrl}/sns/u${userInfo.id}/<#else>${systemProp.appServerUrl}/sns/${(session_user.id)!'0'}/</#if>" src="<#if userInfo.avatar?? && userInfo.avatar!="" >${systemProp.profileServerUrl}${userInfo.avatar!}<#else>${systemProp.staticServerUrl}/images/head172.gif</#if>" onerror="this.src='${systemProp.staticServerUrl}/images/head172.gif'" />
