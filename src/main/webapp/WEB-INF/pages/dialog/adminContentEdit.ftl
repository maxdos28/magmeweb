<#macro main>
 <div id="adminContentEdit" class="popContent" style="width:810px;">
            <h6>作品编辑</h6>
        	<div class="conBody">
                <fieldset>
                ...
                <div class="floatl g320">
                    ...
                    <div>
                        <em>描述</em>
                        <em><textarea id="popContentDescribedDig" maxlength="75" class="input g300"></textarea></em>
                    </div>
                </div>
                <div class="floatl g220 tagList">
                    <ul class="clearFix" id ="popAdminTagList">
                    </ul>
                </div>
                <div class="floatl g210 topicList">
                	<ul id="neteaseCategoryList">
                    	<#--<li><label><input type="checkbox" />专题预留</label></li>-->
                    </ul>
                </div>
                </fieldset>
       		</div>
