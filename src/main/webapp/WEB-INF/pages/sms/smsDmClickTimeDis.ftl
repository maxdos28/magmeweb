<div class="body">
	...
	<script type="text/javascript" src="${systemProp.staticServerUrl}/v3/sms/devjs/smsDmClickTimeDis.js"></script>
    <div class="conLeftMiddleRight">
    	<div class="conTools">
        	<fieldset>
            	...
            	<a class="btnOS" class="current" href="${systemProp.kaiJieAppUrl}/sms/sms-dm-click-time-dis.action">用户推广链接点击时间分布</a>
            </fieldset>
        </div>
