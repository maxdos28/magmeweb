...
<script src="${systemProp.staticServerUrl}/v3/js/ma/adTradeNewOfPub.js"></script>
    	...
    	<div class="con116 conTools">
        	<fieldset>
              ...
              <div>
                    ...
                    <#if publicationCategoryList?exists>
                    	<#list publicationCategoryList as cl>
                    	<em class="g70"><label><input name="keyword" type="checkbox" value="${cl.name?if_exists}" /><strong>${cl.name?if_exists}</strong></label></em>                    	
                    	</#list>
                    </#if>
                    </div>
              </div>
