...
<script type="text/javascript" src="${systemProp.staticServerUrl}/js/jquery-new.min.js"></script>
        ...
        <form method="post" id="uploadIssueForm" enctype="multipart/form-data" onsubmit="return false;">
			<div>
            	...
            	<em>
            		...
            		<input type="text" id="publicationName" name="publicationName" value="${(publication.name)!''}" />
            		<input type="hidden" id="pubType" name="pubType" value="${(publication.pubType)!''}" />
            	</em>
            </div>
            <div>
			...
			<#if publication??&&publication.isFree??>
				<#if publication.isFree==0>
					<div>
