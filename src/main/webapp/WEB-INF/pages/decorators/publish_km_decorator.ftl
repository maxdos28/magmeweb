...
<script type="text/javascript" src="${systemProp.staticServerUrl}/js/jquery.jscrollpane.min.js"></script>
<script type="text/javascript" src="${systemProp.staticServerUrl}/js/jquery.kanmifolder.js"></script>
...
<body>
	<div class="main">
		...
		<!--body-->
		<div id="pageKanmi" name="pageKanmi" class="body pageKanmi clearFix">	
			<!--sideMiddle and sideRight-->    	
			${body}
		</div>
