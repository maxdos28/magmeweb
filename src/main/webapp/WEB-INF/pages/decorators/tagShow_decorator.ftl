...
<script type="text/javascript" src="${systemProp.staticServerUrl}/js/jquery.showTagArea.js"></script>
...
<script type="text/javascript">
  ...
  {
    XN.Main.init("fe16782316da45b6add489d51ccb9150", "xd_receiver.html");
  });
</script>
</body>
</html>
