...
<script type="text/javascript" src="${systemProp.staticServerUrl}/js/swfreader.js"></script>
...
<body>
	<div class="main">
		<!--header-->
		<@header.main menuId="publisherCenter" />
		<!--body-->
		${body}
	</div>
	
	<!--footer-->
	<@footer.main class="footerDesk footerMini"/>
</body>
</html>