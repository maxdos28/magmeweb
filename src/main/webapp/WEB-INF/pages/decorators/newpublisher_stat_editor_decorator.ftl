...
<@np.header class="ios" />
<!--body-->
<div class="body bodyDataPage" menu="iosManageAdmin" label="appData">
	<div class="conLeft">
		<ul class="leftNav clear">
             <li ><a href="#">发行专家数据分析</a>
            	<ul style="display:block">
            	    <!--<li><a href="/newpublisherstat/dm-retention!editorExecute.action">联网方式</a></li>-->
                    <li><a href="/newpublisherstat/dm-app-usage-new-details!editorExecute.action">联网方式</a></li>
                    <li><a href="/newpublisherstat/dm-stayed-user!editorExecute.action">留存用户</a></li>
                    <li><a href="/newpublisherstat/dm-device-analysis!editorExecute.action">终端用户分析</a></li>
                    <#--<li><a href="/newpublisherstat/dm-visit-device-pv-uv!editorExecute.action">App应用数据</a></li>-->
                </ul>
            </li>
        </ul>
    </div>
