<html>
<head>
<title>管理员阅读器 <#if issue??>${issue.publicationName?default('')} ${issue.issueNumber?default('')}</#if></title>
...
<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%" id="readerTool">
                <param name="movie" value="${systemProp.appServerUrl}/reader/EditorTool.swf" />
                <param name="quality" value="high" />
                <param name="bgcolor" value="#ffffff" />
                <param name="allowScriptAccess" value="sameDomain" />
                <param name="allowFullScreen" value="true" />
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="${systemProp.appServerUrl}/reader/EditorTool.swf" width="100%" height="100%">
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />
                    <param name="allowScriptAccess" value="sameDomain" />
                    <param name="allowFullScreen" value="true" />
	...
	<div id="swfReader" style="width: 100%;height: 100%;  z-index:0;">
		<object wmode="Transparent" id="embedSwf1"
			...
			<embed wmode="window" id="embedSwf2"
				src="${systemProp.appServerUrl}/reader/EditorTool.swf"
