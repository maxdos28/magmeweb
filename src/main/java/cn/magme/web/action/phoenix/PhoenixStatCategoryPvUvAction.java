 ...
 *
 */
@Results({@Result(name="success",location="/WEB-INF/pages/phoenix/statCategoryPvUv.ftl")})
public class PhoenixStatCategoryPvUvAction extends BaseAction {
	@Resource
	private PhoenixStatService phoenixStatService;
	@Resource
	private PhoenixCategoryService phoenixCategoryService;
	private static final Logger log=Logger.getLogger(PhoenixStatCategoryPvUvAction.class);
	...
	public String searchCategoryPvUvJson()
	{
		...
		List<Map> l = this.phoenixStatService.searchCategoryPvUv(startDate, endDate, categoryId, appId);
