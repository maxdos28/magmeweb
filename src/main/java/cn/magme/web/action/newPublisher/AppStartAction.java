 ...
 * @since 2013-5-22
 */
@Results({@Result(name="success",location="/WEB-INF/pages/newPublisher/appStart.ftl"),
	@Result(name="index",location="/WEB-INF/pages/newPublisher/appStartIndex.ftl")})
...
//			res=this.phoenixAppStartDao.queryByDateRangeGroupByOs(getSessionAppId(),startDate, endDate);
//		}else{
//			res=this.phoenixAppStartDao.queryByDateRangeOsGroupByOsVersion(getSessionAppId(),startDate, endDate, os);
//		}
//		
//		if(res!=null){
...
//		actions.add(1);
//		GroupByResults<DateCountResult> res=this.phoenixAppStartDao.queryByDateRangeAndOsGroupByTime(getSessionAppId(),actions, startDate, endDate, os);
//		if(res!=null){
