 ...
 * @version $id$
 */
@Results({ @Result(name = "success", location = "/WEB-INF/pages/widget/widgetReader.ftl")
//@Result(name="pubreader", type="redirectAction", params = {"id" , "pageId"}) 
})
public class WidgetReadAction extends BaseAction {
    ...
    private static final Logger log = Logger.getLogger(WidgetReadAction.class);
