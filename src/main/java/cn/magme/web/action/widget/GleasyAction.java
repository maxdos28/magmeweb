...
@Results({ @Result(name = "success", location = "/WEB-INF/pages/widget/gleasyPub.ftl"),
	@Result(name = "pub", location = "/WEB-INF/pages/widget/gleasyPub.ftl"),
	@Result(name = "read", location = "/WEB-INF/pages/widget/gleasyRead.ftl"),
	@Result(name = "category", location = "/WEB-INF/pages/dialog/feedbacksmall.ftl")})
public class GleasyAction extends BaseAction {
	...
	private static final Logger log = Logger.getLogger(GleasyAction.class);
