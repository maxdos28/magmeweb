...
@Results({@Result(name="success",location="/WEB-INF/pages/ad/manageAdMyAd.ftl"),
    @Result(name="queryAjax",location="/WEB-INF/pages/ad/manageAdMyAd_queryAjax.ftl")})
public class ManageMyAdAction extends BaseAction {
    @Resource
