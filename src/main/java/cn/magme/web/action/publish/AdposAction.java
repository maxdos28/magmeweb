...
public class AdposAction extends BaseAction {
	...
	private static final Logger log=Logger.getLogger(AdposAction.class);
	...
	public String addPos(){
		...
		if(NumberUtil.isLessThanOrEqual0(posy) || NumberUtil.isLessThanOrEqual0(posx) 
				|| NumberUtil.isLessThanOrEqual0(pageNo) || NumberUtil.isLessThanOrEqual0(issueId) 
				|| NumberUtil.isLessThan0(status) 
				|| StringUtil.isBlank(keywords) || StringUtil.isBlank(title)){
