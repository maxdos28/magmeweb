...
public class AuthcodeAction extends BaseAction {
    ...
    public String execute() throws Exception {
        ...
        ActionContext.getContext().getSession().put(WebConstant.SESSION.PUBLISHER_AUTHCODE, rdnu.getString());
        log.debug("authcode=====" + ActionContext.getContext().getSession().get(WebConstant.SESSION.PUBLISHER_AUTHCODE));     
        return SUCCESS;
    }
